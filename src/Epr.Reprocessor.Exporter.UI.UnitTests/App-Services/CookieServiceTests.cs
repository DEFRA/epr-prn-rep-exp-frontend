...
namespace Epr.Reprocessor.Exporter.UI.UnitTests.App_Services;

[TestClass]
public class CookieServiceTests
{
    private Mock<ILogger<CookieService>> _loggerMock;
    private Mock<IOptions<CookieOptions>> _cookieOptionsMock;
    ...
    public void Setup()
    {
        ...
        _cookieOptionsMock = new Mock<IOptions<CookieOptions>>();
        _googleAnalyticsOptionsMock = new Mock<IOptions<GoogleAnalyticsOptions>>();

        _cookieOptionsMock.Setup(o => o.Value).Returns(new CookieOptions
        {

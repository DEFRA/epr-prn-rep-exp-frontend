...
{
    [Route(PagePaths.ExporterWasteCarrierBrokerDealerRegistration)]
    public class WasteCarrierBrokerDealerController : ExporterJourneyPageController<
        WasteCarrierBrokerDealerController, IWasteCarrierBrokerDealerRefService, WasteCarrierBrokerDealerRefDto, WasteCarrierBrokerDealerRefViewModel>
    {
        ...
        protected override Task<WasteCarrierBrokerDealerRefDto> GetDtoAsync(Guid registrationId) => 
            _service.GetByRegistrationId(registrationId);

        protected override Task SaveDtoAsync(WasteCarrierBrokerDealerRefDto dto) =>
            _service.Save(dto);
    }
}
